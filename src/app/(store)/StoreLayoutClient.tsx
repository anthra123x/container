        ...
        <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-gray-500">
              ...
              <li><Link href="/terminos" className="transition-colors hover:text-blue-600">Términos y condiciones</Link></li>
              <li><Link href="/privacidad" className="transition-colors hover:text-blue-600">Política de privacidad</Link></li>
            </ul>
          </div>
          <div>

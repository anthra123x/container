...
-- CreateEnum
CREATE TYPE "OrderSource" AS ENUM ('STORE', 'WHATSAPP', 'MANUAL');

-- CreateEnum
CREATE TYPE "VariantType" AS ENUM ('COLOR', 'STORAGE', 'SIZE', 'OTHER');
...
CREATE TABLE "ProductVariant" (
    ...
    "productId" TEXT NOT NULL,
    "name" TEXT NOT NULL,
    "type" "VariantType" NOT NULL DEFAULT 'OTHER',
    "value" TEXT NOT NULL,
    "sku" TEXT,
    "price" DECIMAL(10,2),
    "stock" INTEGER,
...
-- CreateIndex
CREATE UNIQUE INDEX "StoreConfiguration_storeId_key" ON "StoreConfiguration"("storeId");
